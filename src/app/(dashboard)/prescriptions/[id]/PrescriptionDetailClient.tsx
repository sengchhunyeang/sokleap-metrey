      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="bg-white border-2 border-[#4A90D9] p-6 print:border print:p-4">
          ...
          <div className="flex items-center justify-between mb-4 pb-4 border-b border-[#4A90D9]">
            <img src="/next.svg" alt="Next.js Logo" className="h-14 w-auto" />
            <div className="text-center">
              <h1 className="text-[20px] font-bold text-[#4A90D9]">Next.js</h1>
            </div>
            <img src="/next.svg" alt="Next.js Logo" className="h-14 w-auto" />
          </div>

          {/* Title */}
          <h2 className="text-[22px] font-bold text-center text-[#4A90D9] mb-4">Prescription</h2>
